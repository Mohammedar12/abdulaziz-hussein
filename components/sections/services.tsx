    ...
    >
      <div className="mx-auto w-full max-w-7xl px-4 md:px-8">
        <div className="max-w-3xl">
          ...
          <h2
            data-reveal
            className="mt-4 font-heading text-3xl text-foreground"
          ...
          {items.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <span
                  aria-hidden
                  className="absolute inset-x-6 top-0 h-px bg-primary md:inset-x-8"
                />
                ...
                <h3 className="mt-6 font-heading text-xl text-foreground md:text-2xl">
                  {item.title}
                </h3>
