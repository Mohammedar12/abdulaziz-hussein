...
export function About() {
  ...
  useGSAP(
    () => {
      ...
      gsap.from(root.current.querySelectorAll("[data-about-reveal]"), {
        opacity: 0,
        y: 30,
        duration: 0.9,
        ease: "power2.out",
    ...
    <section id="about" ref={root} className="border-b border-border bg-background py-24 md:py-32">
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-12 px-4 md:px-8 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="lg:col-span-5">
          <div data-about-reveal className="relative aspect-[4/5] w-full overflow-hidden rounded-xl border border-border bg-surface">
            <Image
          ...
          <div data-about-reveal className="mt-6 grid grid-cols-2 gap-3">
        ...
        <div className="lg:col-span-7">
          <div data-about-reveal className="text-xs uppercase tracking-[0.25em] text-primary">
            {t("eyebrow")}
          </div>
          <h2
            data-about-reveal
          ...
          <p data-about-reveal className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
            {t("lead")}
          </p>
          <p data-about-reveal className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
            {t("body")}
          </p>

          <div data-about-reveal className="mt-8 rounded-lg border-l-2 border-primary bg-surface/60 p-5 rtl:border-l-0 rtl:border-r-2">
            <div className="text-xs uppercase tracking-wider text-primary">Vision 2030</div>
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-foreground md:text-base">{t("vision")}</p>
          </div>

          <div data-about-reveal className="mt-10">
